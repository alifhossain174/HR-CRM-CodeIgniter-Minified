    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="box-block">
          ...
          <div class="col-md-5">
            <canvas id="employee_department" height="320" width="" style="display: block;  height: 320px;"></canvas>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="box-block">
          ...
          <div class="col-md-5">
            <canvas id="employee_designation" height="320" width="" style="display: block; height: 320px;"></canvas>
          </div>
        </div>
      </div>
    </div>
